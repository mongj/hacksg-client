...
function main(
  Year: number,
  Main_Info: Array<number>,
  Assets: Array<number>,
  DebtList: Array<Array<number>>,
  CurrentExpenditure: number,
  OneOff: Array<number>,
  RetirementIncome: number,
  Retirement_Expenditure: Array<number>,
) {
  let FinalAge = 90;
  var [InitialAge, IdealAge, Income, IncomeG, Legacy] = [
    Main_Info[0],
    Main_Info[1],
    Main_Info[2],
    Main_Info[3],
  ...
  var [Incident, Coninuous, Yearly, Start, End] = [
    OneOff[0],
    OneOff[1],
    OneOff[2],
    OneOff[3],
  ...
  for (let temp in Retirement_Expenditure) {
    RetirementExpenditure += Number(temp);
  }
